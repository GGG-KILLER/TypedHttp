...
{
    [Fact]
    public async Task Generator_GeneratesTraceRequestsCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.Task CheckHealth()
                      {
                          var ___route = "health";
                          using (var ___request = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Trace, ___route))
                          {
