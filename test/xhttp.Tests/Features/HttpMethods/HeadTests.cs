...
{
    [Fact]
    public async Task Generator_GeneratesHeadRequestsCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      {
                          var ___route = "health";
                          using (var ___request = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Head, ___route))
                          {
