...
public class RouteParametersTests : TestBase
{
    [Fact]
    public async Task Generator_GeneratesStringRouteParameterCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.Task<string> GetUserById(string id)
                      {
    ...
    [Fact]
    public async Task Generator_GeneratesNonStringRouteParameterCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.Task<string> GetItemById(int id)
                      {
