...
public class ClientHeadersTests : TestBase
{
    [Fact]
    public async Task Generator_GeneratesSingleClientHeaderCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
    ...
    [Fact]
    public async Task Generator_GeneratesMultipleClientHeadersCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            [Client]
            [Headers("X-Api-Key: my-key", "X-Tenant: tenant1")]
            public interface ICustomClient
            {
                [Get("data")]
                Task<string> GetData();
    ...
    [Fact]
    public async Task Generator_AppliesClientHeaderToEveryMethod()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.Task<string> GetA()
                      {
                          var ___route = "a";
                          using (var ___request = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Get, ___route))
                          {
                      ...
                      public async global::System.Threading.Tasks.Task<string> GetB()
                      {
                          var ___route = "b";
                          using (var ___request = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Get, ___route))
                          {
