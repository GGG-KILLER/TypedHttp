...
public class HttpResponseMessageReturnTypeTests : TestBase
{
    [Fact]
    public async Task Generator_GeneratesHttpResponseMessageReturnTypeCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            {
                [Get("data")]
                Task<HttpResponseMessage> GetDataRaw();
            }
            """);
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.Task<global::System.Net.Http.HttpResponseMessage> GetDataRaw()
                      {
                          var ___route = "data";
    ...
    [Fact]
    public async Task Generator_GeneratesValueTaskOfHttpResponseMessageReturnTypeCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            {
                [Get("data")]
                ValueTask<HttpResponseMessage> GetDataRaw();
            }
            """);
        var expectedOutput = CSharp(
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.ValueTask<global::System.Net.Http.HttpResponseMessage> GetDataRaw()
                      {
                          var ___route = "data";
                          using (var ___request = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Get, ___route))
                          {
