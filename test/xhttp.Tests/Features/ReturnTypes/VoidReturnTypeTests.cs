...
public class VoidReturnTypeTests : TestBase
{
    [Fact]
    public async Task Generator_GeneratesVoidReturnTypeCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.Task DeleteItem(string id)
                      {
    ...
    [Fact]
    public async Task Generator_GeneratesValueTaskReturnTypeCorrectly()
    {
        var source = CSharp(
            """
            using Xhttp;
            ...
            {
                [Delete("items/{id}")]
                ValueTask DeleteItem(string id);
            }
            """);
        var expectedOutput = CSharp(
            $$"""
              ...
              namespace X
              {
                  ...
                  public sealed class CustomClient : ICustomClient
                  {
                      ...
                      public async global::System.Threading.Tasks.ValueTask DeleteItem(string id)
                      {
                          var ___route = $"items/{(global::System.Web.HttpUtility.UrlPathEncode(id.ToString()))}";
                          using (var ___request = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Delete, ___route))
                          {
